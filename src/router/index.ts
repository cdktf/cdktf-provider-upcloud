// https://registry.terraform.io/providers/upcloudltd/upcloud/5.20.5/docs/resources/router
...
export class Router extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Router that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.20.5/docs/resources/router#import import section} in the documentation of this resource for the id to use
