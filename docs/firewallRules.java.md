...
| <code><a href="#@cdktf/provider-upcloud.firewallRules.FirewallRulesFirewallRuleOutputReference.property.internalValue">internalValue</a></code> | <code><a href="#@cdktf/provider-upcloud.firewallRules.FirewallRulesFirewallRule">FirewallRulesFirewallRule</a>\|com.hashicorp.cdktf.IResolvable</code> | *No description.* |
...
```java
public FirewallRulesFirewallRule|IResolvable getInternalValue();
```

- *Type:* <a href="#@cdktf/provider-upcloud.firewallRules.FirewallRulesFirewallRule">FirewallRulesFirewallRule</a>|com.hashicorp.cdktf.IResolvable
