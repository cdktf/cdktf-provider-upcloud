...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9/storage"
...
&storage.StorageConfig {
	...
	Title: *string,
	Zone: *string,
	BackupRule: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9.storage.StorageBackupRule,
	Clone: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9.storage.StorageClone,
	DeleteAutoresizeBackup: interface{},
	FilesystemAutoresize: interface{},
	Id: *string,
	Import: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9.storage.StorageImport,
	Tier: *string,
}
```
