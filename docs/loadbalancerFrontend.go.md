...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8/loadbalancerfrontend"
...
&loadbalancerfrontend.LoadbalancerFrontendConfig {
	...
	Id: *string,
	Networks: interface{},
	Properties: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.loadbalancerFrontend.LoadbalancerFrontendProperties,
}
```
