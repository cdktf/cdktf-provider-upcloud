...
// https://registry.terraform.io/providers/upcloudltd/upcloud/3.3.1/docs
...
export class UpcloudProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing UpcloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.3.1/docs#import import section} in the documentation of this resource for the id to use
