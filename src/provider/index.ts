// https://registry.terraform.io/providers/upcloudltd/upcloud/5.11.0/docs
...
export class UpcloudProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing UpcloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.11.0/docs#import import section} in the documentation of this resource for the id to use
