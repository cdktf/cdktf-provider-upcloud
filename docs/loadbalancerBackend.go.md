...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v12/loadbalancerbackend"
...
&loadbalancerbackend.LoadbalancerBackendConfig {
	...
	Name: *string,
	Id: *string,
	Properties: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v12.loadbalancerBackend.LoadbalancerBackendProperties,
	ResolverName: *string,
}
```
...
| <code><a href="#@cdktf/provider-upcloud.loadbalancerBackend.LoadbalancerBackendConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.3.0/docs/resources/loadbalancer_backend#id LoadbalancerBackend#id}. |
