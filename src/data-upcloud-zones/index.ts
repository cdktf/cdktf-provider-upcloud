...
// https://registry.terraform.io/providers/upcloudltd/upcloud/5.9.1/docs/data-sources/zones
...
export class DataUpcloudZones extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUpcloudZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.9.1/docs/data-sources/zones#import import section} in the documentation of this resource for the id to use
