...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9/network"
...
&network.NetworkConfig {
	...
	IpNetwork: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9.network.NetworkIpNetwork,
	Name: *string,
	Zone: *string,
	Id: *string,
	Router: *string,
