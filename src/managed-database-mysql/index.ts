...
// https://registry.terraform.io/providers/upcloudltd/upcloud/5.30.0/docs/resources/managed_database_mysql
...
export function managedDatabaseMysqlPropertiesMysqlIncrementalBackupToTerraform(struct?: ManagedDatabaseMysqlPropertiesMysqlIncrementalBackupOutputReference | ManagedDatabaseMysqlPropertiesMysqlIncrementalBackup): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function managedDatabaseMysqlPropertiesMysqlIncrementalBackupToHclTerraform(struct?: ManagedDatabaseMysqlPropertiesMysqlIncrementalBackupOutputReference | ManagedDatabaseMysqlPropertiesMysqlIncrementalBackup): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ManagedDatabaseMysqlPropertiesMysqlIncrementalBackupOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ManagedDatabaseMysqlPropertiesMysqlIncrementalBackup | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ManagedDatabaseMysqlPropertiesMysqlIncrementalBackup | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  // full_backup_week_schedule - computed: true, optional: true, required: false
...
export interface ManagedDatabaseMysqlProperties {
  ...
  */
  readonly mysqlIncrementalBackup?: ManagedDatabaseMysqlPropertiesMysqlIncrementalBackup;
}
...
export class ManagedDatabaseMysqlPropertiesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _mysqlIncrementalBackup = new ManagedDatabaseMysqlPropertiesMysqlIncrementalBackupOutputReference(this, "mysql_incremental_backup");
  public get mysqlIncrementalBackup() {
    return this._mysqlIncrementalBackup;
  }
  public putMysqlIncrementalBackup(value: ManagedDatabaseMysqlPropertiesMysqlIncrementalBackup) {
...
export class ManagedDatabaseMysql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedDatabaseMysql that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.30.0/docs/resources/managed_database_mysql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.30.0/docs/resources/managed_database_mysql upcloud_managed_database_mysql} Resource
  *
  * @param scope The scope in which to define this construct
