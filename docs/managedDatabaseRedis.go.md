...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9/manageddatabaseredis"
...
&manageddatabaseredis.ManagedDatabaseRedisConfig {
	...
	Powered: interface{},
	Properties: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9.managedDatabaseRedis.ManagedDatabaseRedisProperties,
	Title: *string,
}
```
...
&manageddatabaseredis.ManagedDatabaseRedisProperties {
	...
	IpFilter: *[]*string,
	Migration: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9.managedDatabaseRedis.ManagedDatabaseRedisPropertiesMigration,
