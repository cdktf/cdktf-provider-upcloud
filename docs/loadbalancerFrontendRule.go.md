...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8/loadbalancerfrontendrule"
...
&loadbalancerfrontendrule.LoadbalancerFrontendRuleConfig {
	...
	Name: *string,
	Priority: *f64,
	Actions: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.loadbalancerFrontendRule.LoadbalancerFrontendRuleActions,
	Id: *string,
	Matchers: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.loadbalancerFrontendRule.LoadbalancerFrontendRuleMatchers,
}
```
