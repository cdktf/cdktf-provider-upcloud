...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9/gateway"
...
&gateway.GatewayConfig {
	...
	Features: *[]*string,
	Name: *string,
	Router: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v9.gateway.GatewayRouter,
	Zone: *string,
