// https://registry.terraform.io/providers/upcloudltd/upcloud/4.0.0/docs/resources/floating_ip_address
...
export class FloatingIpAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FloatingIpAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/4.0.0/docs/resources/floating_ip_address#import import section} in the documentation of this resource for the id to use
