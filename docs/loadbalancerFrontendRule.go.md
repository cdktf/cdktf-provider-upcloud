...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v10/loadbalancerfrontendrule"
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-upcloud.loadbalancerFrontendRule.LoadbalancerFrontendRuleActionsSetForwardedHeaders.property.active">Active</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/2.12.0/docs/resources/loadbalancer_frontend_rule#active LoadbalancerFrontendRule#active}. |
...
&loadbalancerfrontendrule.LoadbalancerFrontendRuleConfig {
	...
	Name: *string,
	Priority: *f64,
	Actions: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v10.loadbalancerFrontendRule.LoadbalancerFrontendRuleActions,
	Id: *string,
	Matchers: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v10.loadbalancerFrontendRule.LoadbalancerFrontendRuleMatchers,
}
```
...
| <code><a href="#@cdktf/provider-upcloud.loadbalancerFrontendRule.LoadbalancerFrontendRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/2.12.0/docs/resources/loadbalancer_frontend_rule#id LoadbalancerFrontendRule#id}. |
