...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v13/kubernetescluster"
...
| <code><a href="#@cdktf/provider-upcloud.kubernetesCluster.KubernetesClusterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/4.1.0/docs/resources/kubernetes_cluster#id KubernetesCluster#id}. |
