...
// https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/managed_database_postgresql
...
export class ManagedDatabasePostgresqlPropertiesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // io_combine_limit - computed: true, optional: true, required: false
  ...
  // io_max_combine_limit - computed: true, optional: true, required: false
  ...
  // io_max_concurrency - computed: true, optional: true, required: false
  ...
  // io_method - computed: true, optional: true, required: false
  ...
  // io_workers - computed: true, optional: true, required: false
...
export class ManagedDatabasePostgresql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedDatabasePostgresql that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/managed_database_postgresql#import import section} in the documentation of this resource for the id to use
