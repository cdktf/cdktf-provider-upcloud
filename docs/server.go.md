...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v6/server"
...
&server.ServerConfig {
	...
	Login: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v6.server.ServerLogin,
	Mem: *f64,
	Metadata: interface{},
	Plan: *string,
	SimpleBackup: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v6.server.ServerSimpleBackup,
	StorageDevices: interface{},
	Tags: *[]*string,
	Template: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v6.server.ServerTemplate,
	Title: *string,
	UserData: *string,
}
```
...
&server.ServerTemplate {
	Storage: *string,
	Address: *string,
	BackupRule: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v6.server.ServerTemplateBackupRule,
