// https://registry.terraform.io/providers/upcloudltd/upcloud/5.5.0/docs/resources/storage
...
export class Storage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Storage that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.5.0/docs/resources/storage#import import section} in the documentation of this resource for the id to use
