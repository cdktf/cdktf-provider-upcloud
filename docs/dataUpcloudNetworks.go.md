...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v12/dataupcloudnetworks"
...
| <code><a href="#@cdktf/provider-upcloud.dataUpcloudNetworks.DataUpcloudNetworksConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.3.1/docs/data-sources/networks#id DataUpcloudNetworks#id}. |
