// https://registry.terraform.io/providers/upcloudltd/upcloud/5.8.0/docs/resources/object_storage
...
export class ObjectStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.8.0/docs/resources/object_storage#import import section} in the documentation of this resource for the id to use
