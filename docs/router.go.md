...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v5/router"
...
| <code><a href="#@cdktf/provider-upcloud.router.Router.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-upcloud.router.RouterConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
