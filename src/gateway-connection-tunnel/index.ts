...
// https://registry.terraform.io/providers/upcloudltd/upcloud/5.24.2/docs/resources/gateway_connection_tunnel
...
export class GatewayConnectionTunnel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GatewayConnectionTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.24.2/docs/resources/gateway_connection_tunnel#import import section} in the documentation of this resource for the id to use
