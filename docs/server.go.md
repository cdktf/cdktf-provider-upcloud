...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v15/server"
...
| <code><a href="#@cdktf/provider-upcloud.server.Server.property.hotResizeInput">HotResizeInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-upcloud.server.Server.property.hotResize">HotResize</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-upcloud.server.ServerConfig.property.hotResize">HotResize</a></code> | <code>interface{}</code> | If set to true, allows changing the server plan without requiring a reboot. |
...
| <code><a href="#@cdktf/provider-upcloud.server.ServerConfig.property.metadata">Metadata</a></code> | <code>interface{}</code> | Is metadata service active for the server. The metadata service must be enabled when using recent cloud-init based templates. |
...
| <code><a href="#@cdktf/provider-upcloud.server.ServerNetworkInterfaceOutputReference.property.indexInput">IndexInput</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-upcloud.server.ServerNetworkInterfaceOutputReference.property.index">Index</a></code> | <code>*f64</code> | *No description.* |
