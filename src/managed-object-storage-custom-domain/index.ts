...
// https://registry.terraform.io/providers/upcloudltd/upcloud/5.19.0/docs/resources/managed_object_storage_custom_domain
...
export class ManagedObjectStorageCustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedObjectStorageCustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.19.0/docs/resources/managed_object_storage_custom_domain#import import section} in the documentation of this resource for the id to use
