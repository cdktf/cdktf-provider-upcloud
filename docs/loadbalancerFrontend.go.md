...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v5/loadbalancerfrontend"
...
| <code><a href="#@cdktf/provider-upcloud.loadbalancerFrontend.LoadbalancerFrontend.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&loadbalancerfrontend.LoadbalancerFrontendConfig {
	...
	Id: *string,
	Networks: interface{},
	Properties: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v5.loadbalancerFrontend.LoadbalancerFrontendProperties,
}
```
...
| <code><a href="#@cdktf/provider-upcloud.loadbalancerFrontend.LoadbalancerFrontendConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
