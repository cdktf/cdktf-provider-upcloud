...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v11/floatingipaddress"
...
| <code><a href="#@cdktf/provider-upcloud.floatingIpAddress.FloatingIpAddressConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.0.3/docs/resources/floating_ip_address#id FloatingIpAddress#id}. |
