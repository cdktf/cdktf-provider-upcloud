// https://registry.terraform.io/providers/upcloudltd/upcloud/3.1.0/docs/data-sources/managed_object_storage_regions
...
export class DataUpcloudManagedObjectStorageRegions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUpcloudManagedObjectStorageRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.1.0/docs/data-sources/managed_object_storage_regions#import import section} in the documentation of this resource for the id to use
