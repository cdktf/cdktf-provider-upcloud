...
// https://registry.terraform.io/providers/upcloudltd/upcloud/5.8.1/docs/data-sources/hosts
...
export class DataUpcloudHosts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUpcloudHosts that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.8.1/docs/data-sources/hosts#import import section} in the documentation of this resource for the id to use
