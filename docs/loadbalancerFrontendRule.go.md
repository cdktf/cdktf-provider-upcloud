...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v7/loadbalancerfrontendrule"
...
&loadbalancerfrontendrule.LoadbalancerFrontendRuleConfig {
	...
	Name: *string,
	Priority: *f64,
	Actions: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v7.loadbalancerFrontendRule.LoadbalancerFrontendRuleActions,
	Id: *string,
	Matchers: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v7.loadbalancerFrontendRule.LoadbalancerFrontendRuleMatchers,
}
```
