...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v5/loadbalancerbackend"
...
&loadbalancerbackend.LoadbalancerBackendConfig {
	...
	Name: *string,
	Id: *string,
	Properties: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v5.loadbalancerBackend.LoadbalancerBackendProperties,
	ResolverName: *string,
}
```
