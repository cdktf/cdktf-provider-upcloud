// https://registry.terraform.io/providers/upcloudltd/upcloud/5.0.3/docs/resources/network
...
export class Network extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Network that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.0.3/docs/resources/network#import import section} in the documentation of this resource for the id to use
