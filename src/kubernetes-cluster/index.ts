// https://registry.terraform.io/providers/upcloudltd/upcloud/3.4.0/docs/resources/kubernetes_cluster
...
export class KubernetesCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.4.0/docs/resources/kubernetes_cluster#import import section} in the documentation of this resource for the id to use
