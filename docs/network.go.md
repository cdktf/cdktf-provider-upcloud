...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v6/network"
...
| <code><a href="#@cdktf/provider-upcloud.network.Network.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&network.NetworkConfig {
	...
	IpNetwork: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v6.network.NetworkIpNetwork,
	Name: *string,
	Zone: *string,
	Id: *string,
	Router: *string,
...
| <code><a href="#@cdktf/provider-upcloud.network.NetworkConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
