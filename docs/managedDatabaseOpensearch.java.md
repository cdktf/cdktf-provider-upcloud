...
| <code><a href="#@cdktf/provider-upcloud.managedDatabaseOpensearch.ManagedDatabaseOpensearch.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.2.0/docs/resources/managed_database_opensearch#id ManagedDatabaseOpensearch#id}. |
...
//  .maxIndexCount(java.lang.Number)
...
| <code><a href="#@cdktf/provider-upcloud.managedDatabaseOpensearch.ManagedDatabaseOpensearchProperties.property.maxIndexCount">maxIndexCount</a></code> | <code>java.lang.Number</code> | Maximum index count. DEPRECATED: use index_patterns instead. |
...
```java
public java.lang.Number getMaxIndexCount();
```
...
```java
public void resetMaxIndexCount()
```
...
| <code><a href="#@cdktf/provider-upcloud.managedDatabaseOpensearch.ManagedDatabaseOpensearchPropertiesOutputReference.property.maxIndexCountInput">maxIndexCountInput</a></code> | <code>java.lang.Number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-upcloud.managedDatabaseOpensearch.ManagedDatabaseOpensearchPropertiesOutputReference.property.maxIndexCount">maxIndexCount</a></code> | <code>java.lang.Number</code> | *No description.* |
...
```java
public java.lang.Number getMaxIndexCountInput();
```
