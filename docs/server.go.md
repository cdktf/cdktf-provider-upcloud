...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8/server"
...
&server.ServerConfig {
	...
	Login: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.server.ServerLogin,
	Mem: *f64,
	Metadata: interface{},
	NicModel: *string,
	Plan: *string,
	SimpleBackup: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.server.ServerSimpleBackup,
	StorageDevices: interface{},
	Tags: *[]*string,
	Template: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.server.ServerTemplate,
	Timezone: *string,
	Title: *string,
	UserData: *string,
	VideoModel: *string,
...
&server.ServerTemplate {
	Storage: *string,
	Address: *string,
	BackupRule: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.server.ServerTemplateBackupRule,
