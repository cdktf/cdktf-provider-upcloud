...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8/network"
...
&network.NetworkConfig {
	...
	IpNetwork: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.network.NetworkIpNetwork,
	Name: *string,
	Zone: *string,
	Id: *string,
	Router: *string,
