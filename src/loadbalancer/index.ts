// https://registry.terraform.io/providers/upcloudltd/upcloud/5.10.0/docs/resources/loadbalancer
...
export class Loadbalancer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Loadbalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.10.0/docs/resources/loadbalancer#import import section} in the documentation of this resource for the id to use
