...
```go
import "github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8/manageddatabaseuser"
...
&manageddatabaseuser.ManagedDatabaseUserConfig {
	...
	Id: *string,
	OpensearchAccessControl: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.managedDatabaseUser.ManagedDatabaseUserOpensearchAccessControl,
	Password: *string,
	PgAccessControl: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.managedDatabaseUser.ManagedDatabaseUserPgAccessControl,
	RedisAccessControl: github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v8.managedDatabaseUser.ManagedDatabaseUserRedisAccessControl,
}
```
