// https://registry.terraform.io/providers/upcloudltd/upcloud/5.14.0/docs/resources/network_peering
...
export class NetworkPeering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.14.0/docs/resources/network_peering#import import section} in the documentation of this resource for the id to use
