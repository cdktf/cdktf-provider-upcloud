...
// https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/data-sources/zone
...
export class DataUpcloudZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUpcloudZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/data-sources/zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/data-sources/zone upcloud_zone} Data Source
  *
  * @param scope The scope in which to define this construct
